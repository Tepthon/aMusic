...
async def start_(client: Client, message: Message):
    await message.reply_text(
        f"""👋🏻 **اهلا سيد {message.from_user.mention()} !**\n
🎗 [{BOT_NAME}](https://t.me/{BOT_USERNAME}) **انا بوت يمديني اشغل اغاني وفيديو في المكالمه المرئيه! 🥇︙**

🥇︙ **لمعرفة اوامري يا حلو  عليك الضغط على زر 🥇 اوامر التشغيل!**
...
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "𝖘𝖔𝖚𝖗𝖈𝖊 𝖙𝖊𝖕𝖙𝖍𝖔𝖓 ", url="https://t.me/Tepthon"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("اوامر التشغيل", url=f"https://t.me/Tepthon"),
                InlineKeyboardButton(
