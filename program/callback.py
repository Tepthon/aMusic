...
# تم التعريب بواسطه سورس تيـبـثــون بموجب حقوق النشر تخمط اذكر المصدر لاهينك 
...
async def cbstart(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""👋🏻 **اهلا سيد [{query.message.chat.first_name}](tg://user?id={query.message.chat.id}) !**\n
🎗 **[{BOT_NAME}](https://t.me/{BOT_USERNAME}) انا بوت اكدر اشغل اغاني وفيديو في المكالمه المرئيه 🥇︙**

🥇︙ **لمعرفة اوامري يا حلو عليك الضغط على 🥇 اوامر التشغيل!**
...
🥇︙ **لمعرفة شلون تفعلني بكروبك اضغط زر 🥇 تفعيل البوت!**""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "⃟𝒔𝒐𝒖𝒓𝒄𝒆 𝒕𝒆𝒑𝒕𝒉𝒐𝒏 ", url="https://t.me/VFF35"
                    )
                ],
            ]
        ),
